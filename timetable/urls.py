...
urlpatterns = [
    ...
    path("holiday/mark/", views.mark_holiday, name="mark_holiday"),
    path("holiday/undo/", views.undo_holiday, name="undo_holiday"),
    path("remove-today/", views.remove_class_today, name="remove_class_today"),
